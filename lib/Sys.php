...
class Sys {
	...
	public static function args () {
		#/opt/haxe/std/php/_std/Sys.hx:41: lines 41-45
		if (array_key_exists("argv", $_SERVER)) {
			#/opt/haxe/std/php/_std/Sys.hx:42: characters 4-89
			return \Array_hx::wrap(array_slice($_SERVER["argv"], 1));
		} else {
			#/opt/haxe/std/php/_std/Sys.hx:44: characters 4-13
			return new \Array_hx();
		}
	}
	...
	public static function command ($cmd, $args = null) {
		#/opt/haxe/std/php/_std/Sys.hx:85: lines 85-95
		if ($args !== null) {
			#/opt/haxe/std/php/_std/Sys.hx:86: characters 12-24
			if (Sys::systemName() === "Windows") {
				#/opt/haxe/std/php/_std/Sys.hx:88: lines 88-91
				$_g = new \Array_hx();
				#/opt/haxe/std/php/_std/Sys.hx:89: lines 89-90
				$_g1 = 0;
				$_g2 = (\Array_hx::wrap([\StringTools::replace($cmd, "/", "\\")]))->concat($args);
				while ($_g1 < $_g2->length) {
					#/opt/haxe/std/php/_std/Sys.hx:89: characters 12-13
					$a = ($_g2->arr[$_g1] ?? null);
					#/opt/haxe/std/php/_std/Sys.hx:89: lines 89-90
					++$_g1;
					#/opt/haxe/std/php/_std/Sys.hx:90: characters 8-37
					$x = SysTools::quoteWinArg($a, true);
					$_g->arr[$_g->length++] = $x;
				}
				#/opt/haxe/std/php/_std/Sys.hx:88: characters 6-9
				$cmd = $_g->join(" ");
			} else {
				#/opt/haxe/std/php/_std/Sys.hx:93: characters 12-57
				...
				#/opt/haxe/std/php/_std/Sys.hx:93: characters 6-9
				$cmd = \Array_hx::wrap($result)->join(" ");
			}
		}
		#/opt/haxe/std/php/_std/Sys.hx:96: characters 3-30
		$result = Boot::deref(0);
		#/opt/haxe/std/php/_std/Sys.hx:97: characters 3-29
		system($cmd, $result);
		#/opt/haxe/std/php/_std/Sys.hx:98: characters 3-16
		return $result;
	}
	...
	public static function cpuTime () {
		#/opt/haxe/std/php/_std/Sys.hx:110: characters 3-54
	...
	public static function environment () {
		#/opt/haxe/std/php/_std/Sys.hx:125: characters 3-33
		$env = $_SERVER;
		#/opt/haxe/std/php/_std/Sys.hx:126: lines 126-128
		$collection = Sys::$customEnvVars;
		foreach ($collection as $key => $value) {
			#/opt/haxe/std/php/_std/Sys.hx:127: characters 4-21
			$env[$key] = $value;
		}
		#/opt/haxe/std/php/_std/Sys.hx:129: characters 3-45
	...
	public static function executablePath () {
		#/opt/haxe/std/php/_std/Sys.hx:114: characters 10-48
	...
	public static function exit ($code) {
		#/opt/haxe/std/php/_std/Sys.hx:102: characters 3-20
		exit($code);
	}
	...
	public static function getChar ($echo) {
		#/opt/haxe/std/php/_std/Sys.hx:148: characters 3-37
		$c = fgetc(STDIN);
		#/opt/haxe/std/php/_std/Sys.hx:149: lines 149-155
		if ($c === false) {
			#/opt/haxe/std/php/_std/Sys.hx:150: characters 4-12
			return 0;
		} else {
			#/opt/haxe/std/php/_std/Sys.hx:152: lines 152-153
			if ($echo) {
				#/opt/haxe/std/php/_std/Sys.hx:153: characters 5-19
				echo($c);
			}
			#/opt/haxe/std/php/_std/Sys.hx:154: characters 4-24
			return ord($c);
		}
	}
	...
	public static function getCwd () {
		#/opt/haxe/std/php/_std/Sys.hx:67: characters 3-29
		$cwd = getcwd();
		#/opt/haxe/std/php/_std/Sys.hx:68: lines 68-69
		if ($cwd === false) {
			#/opt/haxe/std/php/_std/Sys.hx:69: characters 4-15
			return null;
		}
		#/opt/haxe/std/php/_std/Sys.hx:70: characters 3-37
		$l = mb_substr($cwd, -1, null);
		#/opt/haxe/std/php/_std/Sys.hx:71: characters 3-61
	...
	public static function getEnv ($s) {
		#/opt/haxe/std/php/_std/Sys.hx:49: characters 3-32
		$value = getenv($s);
		#/opt/haxe/std/php/_std/Sys.hx:50: characters 10-39
		if ($value === false) {
			#/opt/haxe/std/php/_std/Sys.hx:50: characters 27-31
			return null;
		} else {
			#/opt/haxe/std/php/_std/Sys.hx:50: characters 34-39
			return $value;
		}
	}
	...
	public static function print ($v) {
		#/opt/haxe/std/php/_std/Sys.hx:33: characters 3-29
		echo(\Std::string($v));
	}
	...
	public static function println ($v) {
		#/opt/haxe/std/php/_std/Sys.hx:37: characters 3-45
	...
	public static function programPath () {
		#/opt/haxe/std/php/_std/Sys.hx:121: characters 3-22
	...
	public static function putEnv ($s, $v) {
		#/opt/haxe/std/php/_std/Sys.hx:54: characters 3-26
		Sys::$customEnvVars[$s] = "" . ($v??'null');
		#/opt/haxe/std/php/_std/Sys.hx:55: characters 3-25
	...
	public static function setCwd ($s) {
		#/opt/haxe/std/php/_std/Sys.hx:75: characters 3-18
		chdir($s);
	}
	...
	public static function setTimeLocale ($loc) {
		#/opt/haxe/std/php/_std/Sys.hx:63: characters 3-55
	...
	public static function sleep ($seconds) {
		#/opt/haxe/std/php/_std/Sys.hx:59: characters 10-51
	...
	public static function stderr () {
		#/opt/haxe/std/php/_std/Sys.hx:143: characters 3-87
		$p = (defined("STDERR") ? STDERR : fopen("php://stderr", "w"));
		#/opt/haxe/std/php/_std/Sys.hx:144: characters 3-43
	...
	public static function stdin () {
		#/opt/haxe/std/php/_std/Sys.hx:133: characters 3-84
		$p = (defined("STDIN") ? STDIN : fopen("php://stdin", "r"));
		#/opt/haxe/std/php/_std/Sys.hx:134: characters 3-42
	...
	public static function stdout () {
		#/opt/haxe/std/php/_std/Sys.hx:138: characters 3-87
		$p = (defined("STDOUT") ? STDOUT : fopen("php://stdout", "w"));
		#/opt/haxe/std/php/_std/Sys.hx:139: characters 3-43
		return new FileOutput($p);
	}
	...
	public static function systemName () {
		#/opt/haxe/std/php/_std/Sys.hx:79: characters 3-33
		$s = php_uname("s");
		#/opt/haxe/std/php/_std/Sys.hx:80: characters 3-26
		$p = HxString::indexOf($s, " ");
		#/opt/haxe/std/php/_std/Sys.hx:81: characters 10-39
		if ($p >= 0) {
			#/opt/haxe/std/php/_std/Sys.hx:81: characters 20-34
			return mb_substr($s, 0, $p);
		} else {
			#/opt/haxe/std/php/_std/Sys.hx:81: characters 37-38
			return $s;
		}
	}
	...
	public static function time () {
		#/opt/haxe/std/php/_std/Sys.hx:106: characters 3-32
