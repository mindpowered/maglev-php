...
class MagLevError {
	...
	public static function create ($code, $message, $data) {
		#/src/maglev/MagLev.hx:244: characters 9-44
		$code2 = new MagLevNumber($code);
		#/src/maglev/MagLev.hx:245: characters 9-50
		$message2 = new MagLevString($message);
		#/src/maglev/MagLev.hx:246: characters 9-54
	...
	public static function getStaticType () {
		#/src/maglev/MagLev.hx:266: characters 9-19
		return 100;
	}
	...
	public function __construct ($code, $message, $data) {
		#/src/maglev/MagLev.hx:249: characters 9-25
		$this->code = $code;
		#/src/maglev/MagLev.hx:250: characters 9-31
		$this->message = $message;
		#/src/maglev/MagLev.hx:251: characters 9-25
		$this->data = $data;
	}
	...
	public function getCode () {
		#/src/maglev/MagLev.hx:254: characters 9-29
	...
	public function getData () {
		#/src/maglev/MagLev.hx:260: characters 9-20
		return $this->data;
	}
	...
	public function getMessage () {
		#/src/maglev/MagLev.hx:257: characters 9-35
	...
	public function getType () {
		#/src/maglev/MagLev.hx:263: characters 9-19
		return 100;
	}
	...
	public function isEqual ($other) {
		#/src/maglev/MagLev.hx:270: characters 9-30
		$same = true;
		#/src/maglev/MagLev.hx:271: characters 24-71
		$same = $same && $this->code->isEqual(new MagLevNumber($other->getCode()));
		#/src/maglev/MagLev.hx:272: characters 24-77
		$same = $same && $this->message->isEqual(new MagLevString($other->getMessage()));
		#/src/maglev/MagLev.hx:273: characters 24-53
		$same = $same && $this->data->isEqual($other->getData());
		#/src/maglev/MagLev.hx:274: characters 9-20
		return $same;
	}
	...
	public function toJson () {
		#/src/maglev/MagLev.hx:277: characters 9-135
