...
class Host {
	...
	public static function localhost () {
		#/opt/haxe/std/php/_std/sys/net/Host.hx:60: characters 3-64
	...
	public function __construct ($name) {
		#/opt/haxe/std/php/_std/sys/net/Host.hx:37: characters 3-14
		$this->host = $name;
		#/opt/haxe/std/php/_std/sys/net/Host.hx:38: lines 38-46
		if ((new \EReg("^(\\d{1,3}\\.){3}\\d{1,3}\$", ""))->match($name)) {
			#/opt/haxe/std/php/_std/sys/net/Host.hx:39: characters 4-14
			$this->_ip = $name;
		} else {
			#/opt/haxe/std/php/_std/sys/net/Host.hx:41: characters 4-29
			$this->_ip = gethostbyname($name);
			#/opt/haxe/std/php/_std/sys/net/Host.hx:42: lines 42-45
			if ($this->_ip === $name) {
				#/opt/haxe/std/php/_std/sys/net/Host.hx:43: characters 5-11
				$this->ip = 0;
				#/opt/haxe/std/php/_std/sys/net/Host.hx:44: characters 5-11
				return;
			}
		}
		#/opt/haxe/std/php/_std/sys/net/Host.hx:47: characters 3-26
		$p = HxString::split($this->_ip, ".");
		#/opt/haxe/std/php/_std/sys/net/Host.hx:48: characters 3-71
	...
	public function reverse () {
		#/opt/haxe/std/php/_std/sys/net/Host.hx:56: characters 3-28
	...
	public function toString () {
		#/opt/haxe/std/php/_std/sys/net/Host.hx:52: characters 3-13
		return $this->_ip;
	}
